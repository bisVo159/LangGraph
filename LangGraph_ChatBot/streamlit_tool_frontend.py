...
from langgraph_tool_backend import chatbot, retrieve_all_threads, save_thread, delete_thread, retrieve_state_threads, clear_all_threads_and_checkpoints
...
if user_input := st.chat_input("What is up?"):
    ...
    with st.chat_message("assistant"):
        ...
        if status_holder["box"] is not None:
            status_holder["box"].update(
                label=f"✅ {tool_name} finished", state="complete", expanded=False
            )
